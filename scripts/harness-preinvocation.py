...
def main():
    ...
    guidance = (
        ...
        f"  4. Subagents (/teamwork-preview & /boost): When invoked, immediately dispatch subagents via invoke_subagent—never hijack into single-agent work. Inject 'agy-zen' into worker prompts (Model: 'flash') to prevent 429 lockouts."
    )
